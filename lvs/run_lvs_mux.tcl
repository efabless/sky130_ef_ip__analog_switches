...
set circuit1 [readnet spice ../netlist/layout/simple_analog_mux_sel1v8.spice]
set circuit2 [readnet spice $hvlib]
readnet spice ../netlist/schematic/simple_analog_mux_sel1v8.spice $circuit2

lvs "$circuit1 simple_analog_mux_sel1v8" "$circuit2 simple_analog_mux_sel1v8" \
        $setupfile simple_analog_mux_sel1v8_comp.out
