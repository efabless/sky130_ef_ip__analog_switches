...
set circuit1 [readnet spice ../netlist/layout/minimal_n_switch_ena1v8.spice]
set circuit2 [readnet spice $hvlib]
readnet spice ../netlist/schematic/minimal_n_switch_ena1v8.spice $circuit2

lvs "$circuit1 minimal_n_switch_ena1v8" "$circuit2 minimal_n_switch_ena1v8" \
        $setupfile minimal_n_switch_ena1v8_comp.out
